...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-green-50 via-white to-blue-50 flex items-center justify-center px-4 py-12" data-aos="zoom-out" >
      <div className="max-w-md w-full space-y-8 bg-white/80 backdrop-blur-lg rounded-3xl p-8 border border-gray-100 shadow-2xl ">
        {/* Logo */}
  ...
  />
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-green-600 text-white py-3 px-4 rounded-xl hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed font-semibold flex items-center justify-center gap-2 transition-colors duration-300 shadow-sm hover:shadow-lg"
          >
            {loading ? (
              <>
